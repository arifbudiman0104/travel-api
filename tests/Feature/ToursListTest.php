...
class ToursListTest extends TestCase
{
    ...
    public function test_tour_list_sorts_starting_date_correcly(): void
    {
        $travel = Travel::factory()->create();
    ...
    public function test_tours_list_sorts_by_price_correcly(): void
    {
        $travel = Travel::factory()->create();
    ...
    public function test_tours_list_filters_by_price_correcly(): void
    {
        $travel = Travel::factory()->create();
        $expensiveTour = Tour::factory()->create([
            'travel_id' => $travel->id,
    ...
    public function test_tours_list_filters_by_starting_date_correcly(): void
    {
        $travel = Travel::factory()->create();
        $laterTour = Tour::factory()->create([
            'travel_id' => $travel->id,
